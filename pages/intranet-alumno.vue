<template>
    <div class="intranet-alumno">
        ...
        <div class="intranet-alumno-body">
                ...
                <div class="options__menu">	
                    ...
                    <a href="#registro" @click="viewRegistro()">
                        <div class="option">
                            ...
                            <h6> <strong><i class="bi bi-calendar-fill" title="Registro" style="font-size: 1.5rem"></i>Asistencia</strong></h6>
                        </div>
                    </a>
                    ...
                    <a href="http://localhost:3000/login-alumno">
                        <div class="option">
...
<style>
    .intranet-alumno-body{
        display: flex;
    }

    .option-intranet-alumno{
        width: 75%;
        position: absolute;
        right: 0;
    }
